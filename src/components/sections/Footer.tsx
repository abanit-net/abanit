          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
            ...
            <FooterSection title="خدمات">
              <ul className="space-y-3">
                <li><FooterLink href="#">طراحی سایت</FooterLink></li>
                <li><FooterLink href="#">سئو و بهینه‌سازی</FooterLink></li>
                <li><FooterLink href="#">هوش مصنوعی</FooterLink></li>
                <li><FooterLink href="#">طراحی گرافیک</FooterLink></li>
              </ul>
            </FooterSection>
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              >
                ...
                <a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">شرایط استفاده</a>
              </motion.div>
            </div>
          </div>
        </div>
