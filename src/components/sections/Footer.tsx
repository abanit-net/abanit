          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
            <FooterSection title="درباره آبانیت">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <a href="tel:+989335168413" aria-label="تماس تلفنی آبانیت" className="block">
                  <SocialIcon label="تماس">
                    <Phone className="w-5 h-5" />
                  </SocialIcon>
                </a>
                <a href="https://wa.me/989335168413" target="_blank" rel="noopener noreferrer" aria-label="واتساپ آبانیت">
                ...
                <a href="https://t.me/Abanit_Stoker_Admin" target="_blank" rel="noopener noreferrer" aria-label="تلگرام آبانیت">
